...
41. 现在打完一个轮回后房间也会重新随机生成
42. 完善了mk1技能
43. 实现了敌人随关卡升级而升级的机制，优化了宝箱生成逻辑
44. 添加了跑酷房，在游戏中实装了第二套横版逻辑，添加了二段跳
45. 优化了闪避的手感，闪避会默认触发时按键的情况选择方向
46. 迫切需要一个自动生成房间属性的算法！！！
...
15. 文本框溢出问题可以通过textlayout这个组件解决